...
<html lang="en">
    ...
    <%
        ...
        String idDistribuidor = request.getParameter("txtIdDistribuidor");
    ...
    <body>
        <div class="container-fluid">
            ...
            <fieldset>
                <form class="form-signin" action="../actualizarCompra" method="post">
                    <h2 class="form-signin-heading">Actualizar Compra</h2>
                    <input class="form-control" placeholder="Id" required="" autofocus="" type="text" title="Campo requerido" name="txtId" value="<%=id%>" readonly="">
                    <input class="form-control" required="" autofocus="" type="text" title="Campo requerido" name="txtFecha" value="<%=fecha%>">
