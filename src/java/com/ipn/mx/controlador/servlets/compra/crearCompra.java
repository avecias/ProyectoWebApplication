...
@WebServlet(name = "crearCompra", urlPatterns = {"/crearCompra"})
public class crearCompra extends HttpServlet {

    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        response.setContentType("text/html;charset=UTF-8");
        String estado = "Error al crear la compra";
        ...
        try {
            ...
            new CompraDAOImpl().create(compra, conexion);
            estado = "Compra creada con exito";
        } catch (SQLException e) {
            System.err.println("Algo salio mal al crear la compra " + e);
        }
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("Datos de la  compra nueva, Fecha= " + fecha + ", Precio= " + precio + ", idDistribuidor= " + idDistribuidor + ", matricula= " + matricula);
