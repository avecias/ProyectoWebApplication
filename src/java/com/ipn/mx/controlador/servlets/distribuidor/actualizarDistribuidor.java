...
@WebServlet(name = "actualizarDistribuidor", urlPatterns = {"/actualizarDistribuidor"})
public class actualizarDistribuidor extends HttpServlet {

    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        String estado = "Error al actualizar el Distribuidor";
        ...
        try {
            ...
            new DistribuidorDAOImpl().update(distribuidor, conexion);
            estado = "Distribuidor actualizado con exito";
        } catch (SQLException e) {
            System.err.println("Algo salio mal al actualizar el Distribuidor " + e);
        }
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("Datos del distribuidor actualizado, Nombre= " + nombre + ", Ciudad= " + ciudad + ", Direccion= " + direccion + ", Telefono= " + telefono);
