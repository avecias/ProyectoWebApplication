...
@WebServlet(name = "crearAuto", urlPatterns = {"/crearAuto"})
@MultipartConfig(maxFileSize = 16 * 1024 * 1024)
public class crearAuto extends HttpServlet {

    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        response.setContentType("text/html;charset=UTF-8");
        String estado = "Error al crear el auto";
        ...
        try {
            ...
            new AutoDAOImpl().create(auto, conexion, is, (int) foto.getSize());
            estado = "Auto creado con exito";
        } catch (SQLException e) {
            System.err.println("Algo salio mal al crear el auto " + e);
        }
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("Datos del auto nuevo, Matricula= " + matricula + ", Marca= " + marca + ", Modelo= " + modelo + ", precio= " + precio);
